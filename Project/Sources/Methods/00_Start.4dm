...
Case of 
	...
	Else 
		...
		$options.title:="Search a paragraph with chunks"+$cr+"in 4D Write Pro documents"
		...
		Else 
			...
			$win:=Open form window:C675("Search"; Plain form window:K39:10; Horizontally centered:K39:1; Vertically centered:K39:4)
			DIALOG:C40("Search")
			CLOSE WINDOW:C154
